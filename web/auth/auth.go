...
func authorizeForm(c echo.Context) error {
	...
	var client Client
	if err := couchdb.GetDoc(instance, ClientDocType, c.QueryParam("client_id"), &client); err != nil {
		return c.Render(http.StatusBadRequest, "error.html", echo.Map{
