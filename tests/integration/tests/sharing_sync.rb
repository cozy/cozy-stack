...
describe "A folder" do
  it "can be shared to a recipient in sync mode" do
    ...
    meta = child1.cozy_metadata.merge("originalID" => child1.couch_id)
    assert_equal meta, child1_recipient.cozy_metadata
    assert_equal file.name, file_recipient.name
    ...
    meta = file.cozy_metadata.merge("originalID" => file.couch_id)
    assert_equal meta, file_recipient.cozy_metadata
