...
describe "A sharing" do
  ...
  it "can be revoked" do
    ...
    assert_equal "http://alice.test.cozy.tools:8081", owner["instance"]
    ...
    assert_equal "http://bob.test.cozy.tools:8082", recpt1["instance"]
    ...
    assert_equal "Charlie", recpt2["public_name"]
    assert_equal contact_charlie.primary_email, recpt2["email"]
    assert_equal "http://charlie.test.cozy.tools:8083", recpt2["instance"]
