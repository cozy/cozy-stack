## cozy-stack konnectors deactivate-maintenance

Deactivate maintenance for the given konnector

```
cozy-stack konnectors deactivate-maintenance [slug] [flags]
```

### Options

```
  -h, --help   help for deactivate-maintenance
```
